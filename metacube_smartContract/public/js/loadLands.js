...
function updateListDisplay(land)
{
    ...
    var myCard = $('<div class="card" id="inlineCard' + i + '" style="width:250px"><img style="height:50px;" src="../images/main.jpg"><h5>landID: '+ i +'</h5><span>Location: '+ location +'</span><span>Cost: '+ cost +'</span></div>');
